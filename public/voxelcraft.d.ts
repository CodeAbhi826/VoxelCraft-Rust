...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_10862: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_2887: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_851: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2418_5: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_851_6: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2887_7: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2418_8: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2418_9: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2418_10: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2418_11: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2417: (a: number, b: number) => void;
