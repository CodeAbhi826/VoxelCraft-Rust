...
// ---------------------------------------------------------------------------
// 1.8 bracket — the Bountiful-era update (2014-09-02,
...
// ---- 1.13 bracket (Aquatic-era update): ids 361..=416, V9 window ----
...
pub fn default_state(b: u16) -> u16 {
    match b {
        ...
        // 1.13 (Aquatic-era update): the V9 window — 1:1 defaults; the sea
...
pub fn state_block(s: u16) -> u16 {
    ...
    match s {
        ...
        // 1.13 (Aquatic-era update): the V9 window — 1:1 folds; the pickle's
...
/// `textures/block/<loc>.png` REPLACES the pixels of the
...
/// Classic Art builtin pack (the vanilla pre-1.14 retro look-alike)
...
pub fn is_item_block(b: u16) -> bool {
    matches!(
        ...
        POTION_EMPTY | POTION_WATER | POTION_AWKWARD | POTION_MUNDANE | POTION_HEALING
            ...
            | GOLDEN_HELMET | GOLDEN_CHESTPLATE | GOLDEN_LEGGINGS | GOLDEN_BOOTS
            | DIAMOND_HELMET | DIAMOND_CHESTPLATE | DIAMOND_LEGGINGS | DIAMOND_BOOTS
            // ---- 1.13 item-blocks (Aquatic-era update): the conduit/turtle
    ...
    fn prop_states_roundtrip() {
        ...
        || is_v16_state(s)
                ...
                || matches!(s, ACACIA_LOG_X | ACACIA_LOG_Z | DARK_OAK_LOG_X | DARK_OAK_LOG_Z)
            {
                ...
                // 1.11 V7 (Exploration-era update): same roundtrip contract
                if is_v7_state(s) {
                ...
                // 1.13 V9 (Aquatic-era update): 1:1 ids roundtrip; the sea
