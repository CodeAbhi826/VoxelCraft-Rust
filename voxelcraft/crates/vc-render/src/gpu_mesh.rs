...
const L_SB: u32 = 0u;              // lut: state -> block        (STATE_COUNT=676)
const L_FL: u32 = 676u;            // lut: block flags           (BLOCK_COUNT=417)
const L_TC: u32 = 1093u;           // lut: block tint class      (BLOCK_COUNT=417)
const L_ST: u32 = 1510u;           // lut: state tiles, 4/state  (4·STATE_COUNT=2704)
...
fn sb(s: u32) -> u32 { return lut[L_SB + min(s, 675u)]; }
fn fl(b: u32) -> u32 { return lut[L_FL + min(b, 416u)]; }
