...
const L_SB: u32 = 0u;              // lut: state -> block        (STATE_COUNT=689)
const L_FL: u32 = 689u;            // lut: block flags           (BLOCK_COUNT=426)
const L_TC: u32 = 1115u;           // lut: block tint class      (BLOCK_COUNT=426)
const L_ST: u32 = 1541u;           // lut: state tiles, 4/state  (4·STATE_COUNT=2756)
...
fn sb(s: u32) -> u32 { return lut[L_SB + min(s, 688u)]; }
fn fl(b: u32) -> u32 { return lut[L_FL + min(b, 425u)]; }
