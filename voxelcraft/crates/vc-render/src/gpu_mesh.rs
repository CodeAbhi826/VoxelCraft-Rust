...
const L_SB: u32 = 0u;              // lut: state -> block        (STATE_COUNT=328)
const L_FL: u32 = 328u;            // lut: block flags           (BLOCK_COUNT=191)
const L_TC: u32 = 519u;            // lut: block tint class      (BLOCK_COUNT=191)
const L_ST: u32 = 710u;            // lut: state tiles, 4/state  (4·STATE_COUNT=1312)
...
fn sb(s: u32) -> u32 { return lut[L_SB + min(s, 327u)]; }
fn fl(b: u32) -> u32 { return lut[L_FL + min(b, 190u)]; }
