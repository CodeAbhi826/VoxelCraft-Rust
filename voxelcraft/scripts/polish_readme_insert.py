...
| 5 | 1.8 | Bountiful-era update | Granite/diorite/andesite, red sandstone, prismarine, rabbits, slime-block bounce | WORKLOG 2026-09-06 |
...
| 8 | 1.11 | Exploration-era update | Woodland mansions with illager spawners, vindicator/evoker/vex, totem of undying | `verify_v111_*` captures |
...
| 13 | 1.16 | Nether Update (parts 1+2) | Rebirth anchors, targets, lodestones, piglin bartering, hoglins, striders, the crimson/warped families, soul fire | `phase-v116-1.16-research.md` + `phase-v116b-1.16-research.md` |
